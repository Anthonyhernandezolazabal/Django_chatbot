...
class ClientRegisterForm(forms.ModelForm):
    ...
    direccion = forms.CharField(label="Direccion", max_length=250, widget=forms.TextInput(attrs={'class': 'form-control mb-2', 'placeholder': "Ingresa direccion",'autofocus': ''}))
    web = forms.CharField(label="Página web", max_length=100, widget=forms.TextInput(attrs={'class': 'form-control mb-2', 'placeholder': "www.url.com",'autofocus': ''}))
    residencia = forms.CharField(label="Residencia", max_length=120, widget=forms.TextInput(attrs={'class': 'form-control mb-2', 'placeholder': "Departamento / Provincia / Distrito",'autofocus': ''}))
    rubro = forms.CharField(label="Rubro", max_length=150, widget=forms.TextInput(attrs={'class': 'form-control mb-2', 'placeholder': "Ingresa Rubro",'autofocus': ''}))
