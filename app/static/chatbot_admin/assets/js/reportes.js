...
$('input[name="dates"]').daterangepicker({
  ...
  function (start, end, label) {
    ...
    fetch('http://127.0.0.1:8000/historial_fecha/?desde=' + desde + '&hasta=' + hasta + '&id_empresa=' + id_empresa + '', {
      method: 'GET',
...
function ver_conversacion(alias_nom) {
  ...
  fetch('http://127.0.0.1:8000/obtener_conversacion/?usuario_alias=' + alias_nom, {
    method: 'GET',
  }).then(rsp => rsp.json()).then(function (response) {
    var total_datos = response;
    var template = ``;
